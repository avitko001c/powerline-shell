...
from powerline_shell.power.segment import gen_segment_getter, process_segment, get_fallback_segment
from powerline_shell.power.lib.unicode import u, safe_unicode
