...
from powerline_shell.power.ipython import IPythonPowerline, IPythonInfo

if has_prompt_manager:
	from powerline_shell.power.ipython import RewriteResult
...
def load_ipython_extension(ip):
	if has_prompt_manager:
		...
		from powerline_shell.power.bindings.ipython.since_5 import PowerlinePrompts
