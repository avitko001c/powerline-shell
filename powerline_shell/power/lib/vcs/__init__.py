...
from powerline_shell.power.lib.watcher import create_tree_watcher
from powerline_shell.power.lib.unicode import out_u
...
def get_fallback_create_watcher():
	from powerline_shell.power.lib.watcher import create_file_watcher
	from powerline_shell.power import get_fallback_logger
...
def debug():
	...
	To use::
		python -c 'from powerline_shell.power.lib.vcs import debug; debug()' some_file_to_watch.
	'''
	import sys
	dest = sys.argv[-1]
